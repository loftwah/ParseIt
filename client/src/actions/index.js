...
export const toggleOutputTextOn = text.toggleOutputTextOn;
export const toggleOutputTextOff = text.toggleOutputTextOff;
...
export const updateDeletionsPreview = text.updateDeletionsPreview;
export const updateAdditionsPreview = text.updateAdditionsPreview;