...
import tutorialModuleStacking from '../../../images/tutorial-module-stacking.png';
import tutorialModuleStackingCode from '../../../images/tutorial-module-stacking-code.png'
            ...
            <div className="tutorial-nav-component">
                ...
                <div className="tutorial-container">
                    <div className="container-text">
                        ...
                        <img className="large-img" src={tutorialModuleStacking} alt="" />
                        <p className="large-image-caption center grey-text text-darken-1"><i>The input text enters the "Concatenate" module, and then the "Replace Characters" module. The result of this module "stack" is seen inside the Output Text.</i></p>

                        <h6 className="text">As you are manually creating modules, ParseIt automatically generates ParseIt Code - your sequence of modules in code-form. If you were working from scratch, this code is what you would use to load in all modules you are currently working with.</h6>

                        <img className="large-img" src={tutorialModuleStackingCode} alt="" />
                        <p className="large-image-caption center grey-text text-darken-1"><i>The above module stack in code-form, automatically generated by ParseIt.</i></p>
                        ...
                        <h6 className="text preface yellow-highlight" >The goal for ParseIt is not to generate code that works for only one input of data, but code that works for <u>all</u> similarly-structured text.</h6>
