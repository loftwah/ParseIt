                ...
                <div className="multiple-add-text-to-beginning-card card white">
                    ...
                    <div className="row">
                        <div className="multiple-add-text-to-beginning-description-complete col s12">
                            <p>Starting at line number <b>"{lineNumBegin}"</b>, at each line multiple of <b>"{lineMultiple}"</b>, add the characters <b>"{charToAdd}" at the beginning of the specified lines.</b></p>
                        </div>
                    </div>
                </div>
            </div>
