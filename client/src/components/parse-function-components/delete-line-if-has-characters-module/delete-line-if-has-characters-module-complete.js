...
class DeleteLineIfHasCharactersComplete extends Component {
    constructor(props) {
        super(props);
        this.state = {
            chars: '',
    ...
    componentDidMount() {
        ...
        console.log('delete-line-if-has-characters-module-complete component mounted');
...
export default connect(mapStateToProps, actions)(DeleteLineIfHasCharactersComplete);