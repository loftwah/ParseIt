...
class DeleteLineIfHasCharacters extends Component {
    ...
    render() {
        ...
        return (
            <div className="delete-line-if-has-characters-function">
                    ...
                    <div className="row">
                        <form action="#" className="form-add-text-to-beginning-line-multiple col s12">
                            ...
                            <div className="row character-line-input">
                                <div className="delete-line-if-has-characters-characters col s12 m12 l12">
                                    <span>Characters:</span>
                                    <div className="delete-line-if-has-characters-user-input-character insert input-field inline">
                                        <input
                                            type="text"
                                            id="character-input"
...
export default connect(mapStateToProps, actions)(DeleteLineIfHasCharacters);